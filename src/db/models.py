"""SQLAlchemy ORM Database Tables for AthleteIQ Pro."""
...
class AthleteORM(Base):
    """SQLAlchemy table mapping for athlete profiles."""
...
class TelemetryORM(Base):
    """SQLAlchemy table mapping for daily wearable telemetry logs."""
...
class RiskLogORM(Base):
    """SQLAlchemy table mapping for historical risk assessments."""
